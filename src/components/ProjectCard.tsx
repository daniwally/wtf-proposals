...
<button
          ...
          disabled={loading}
          className="px-2 py-1 bg-white/80 text-black rounded-lg hover:bg-transparent hover:text-white hover:border hover:border-white/20 border border-transparent transition-colors cursor-pointer"
          title={project.status === "active" ? "Desactivar" : "Activar"}
        >
          {project.status === "active" ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
          ) : (
        ...
        <button
          ...
          disabled={loading}
          className="px-2 py-1 bg-danger text-white rounded-lg hover:bg-transparent hover:text-danger hover:border-danger border border-transparent transition-colors cursor-pointer ml-auto"
          title="Eliminar"
        >
